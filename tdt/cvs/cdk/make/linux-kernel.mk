...
COMMONPATCHES_24 = \
		...
		$(if $(P0213)$(P0215),linux-tune_stm24_0213.patch) \
		$(if $(P0211)$(P0213)$(P0215),linux-sh4-mmap_stm24.patch) \
		$(if $(P0211)$(P0213)$(P0215),linux-sh4-directfb_stm24$(PATCH_STR).patch) \
...
HL101_PATCHES_24 = $(COMMONPATCHES_24) \
		...
		$(if $(P0211)$(P0213)$(P0215),linux-sh4-hl101_i2c_st40_stm24$(PATCH_STR).patch)
...
SPARK_PATCHES_24 = $(COMMONPATCHES_24) \
		...
		$(if $(P0211)$(P0213)$(P0215),linux-sh4-lirc_stm_stm24$(PATCH_STR).patch) \
		$(if $(P0211)$(P0213)$(P0215),linux-sh4-fix-crash-usb-reboot_stm24_0211.diff)
